...
/**
 * shash_table_create - creates a shash table with size
 *
 * @size: size of the shash table
 * Return: the created shash table, or NULL on failure
 */
...
/**
 * add_n_shash - adds a node at the begn of a shash at index
 *
...
/**
 * add_i_shash - adds a node on hash table
 *
 ...
 * @value: value to store of the table
...
/**
 * shash_table_get - retrieves a value of the hash table with a key
 *
...
/**
 * shash_table_print - prints the keys and values of the shash
 *
 * @ht: pointer to the shash table
...
/**
 * shash_table_print_rev - prints the keys of the hash table
 *
 * @ht: pointer to the shash table
 * Return: no return
 */
